...
export function SuporteWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 left-4 z-40 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 sm:bottom-6"
    >

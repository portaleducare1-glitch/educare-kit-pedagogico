  ...
  return (
    <Link
      ...
      className={cn(
        ...
        visitado ? 'border-border/50 opacity-70' : 'border-border',
        'hover:border-primary/40 hover:shadow-sm hover:opacity-100 transition-all',
      )}
    >
